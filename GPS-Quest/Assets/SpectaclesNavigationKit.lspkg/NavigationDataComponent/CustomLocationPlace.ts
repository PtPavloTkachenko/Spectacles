...
// The user must be within 5m of a location in order to visit it.
const revisitDistance = 500
...
export class CustomLocationPlace extends GeoLocationPlace {
  ...
  protected checkVisited(): boolean {
    ...
    return this._isTracking && this.getDisplacementWorldSpace().length < revisitDistance
  }
